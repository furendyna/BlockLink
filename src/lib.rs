...
#[derive(Debug)]
pub struct BlockLinkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockLinkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockLink processing");
    
    let mut processor = BlockLinkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockLinkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockLinkProcessor::new(false);
